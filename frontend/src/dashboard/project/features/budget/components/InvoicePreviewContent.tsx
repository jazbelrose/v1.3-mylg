  ...
  return (
    <div className={styles.previewWrapper} ref={previewRef}>
      <style id="invoice-preview-styles">{`
        ...
        .invoice-page{width:min(100%,210mm);max-width:210mm;min-height:297mm;box-shadow:0 2px 6px rgba(0,0,0,0.15);margin:0 auto 20px;padding:20px 20px 40px;box-sizing:border-box;position:relative;overflow-x:hidden;display:flex;flex-direction:column;}
        ...
        @media screen and (max-width:768px){
          ...
          .invoice-page{padding:16px 16px 36px;width:100%;min-height:auto;}
        ...
        @media screen and (max-width:480px){
          .invoice-page{padding:12px 12px 36px;}
        ...
        @media print{
          ...
          .invoice-page{width:210mm;max-width:210mm;height:297mm;min-height:auto;box-shadow:none;margin:0;page-break-after:always;padding:20px 20px 40px;}

  ...
  return (
    <div className={styles.previewWrapper} ref={previewRef}>
      ...
      <style id="invoice-preview-styles">{`
        ...
        .pageNumber{margin-top:auto;padding-top:24px;text-align:center;font-family:'Roboto',Arial,sans-serif;font-size:0.85rem;color:#666;font-weight:normal;pointer-events:none;user-select:none;}
        @media print{

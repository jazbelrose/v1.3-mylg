  ...
  return (
    <div className={styles.previewWrapper} ref={previewRef}>
      ...
      <style id="invoice-preview-styles">{`
        ...
        .pageNumber{position:absolute;bottom:24px;left:0;right:0;text-align:center;font-family:'Roboto',Arial,sans-serif;font-size:0.85rem;color:#666;font-weight:normal;pointer-events:none;user-select:none;}
        @media print{

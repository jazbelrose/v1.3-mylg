...
export const TASTE_MODES: Record<TasteModeId, TasteMode> = {
  "apple-clean": {
    id: "apple-clean",
    name: "Apple Clean",
    description: "Minimalist, modern aesthetic with subtle spacing.",
    tokens: APPLE_CLEAN_TOKENS,
  },
  "brutalist-grid": {
    id: "brutalist-grid",
    name: "Brutalist",
    description: "Bold, high-contrast with strong typography.",
    tokens: BRUTALIST_GRID_TOKENS,
  },
  "fashion-editorial": {
    id: "fashion-editorial",
    name: "Fashion",
    description: "Elegant serif typography with refined spacing.",
  ...
  "pinterest-collage": {
    ...
    name: "Pinterest",
    description: "Casual, social media-friendly.",
    tokens: PINTEREST_COLLAGE_TOKENS,
  },
  "museum-wall": {
    id: "museum-wall",
    name: "Museum",
    description: "Classic, serif-based for formal presentations.",

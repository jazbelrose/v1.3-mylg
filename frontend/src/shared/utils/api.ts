...
const BASE_ENDPOINTS = {
  ...
  WEBSOCKET_URL: 'wss://nt3enat0ik.execute-api.us-west-2.amazonaws.com/dev',
  ...
  CREATE_GALLERY_FUNCTION_URL: 'https://89lpls2fsg.execute-api.us-west-2.amazonaws.com/projects/galleries/process',
  DELETE_GALLERY_FUNCTION_URL: 'https://89lpls2fsg.execute-api.us-west-2.amazonaws.com/projects/galleries/process',
  ...
  DECK_REALTIME_WS_URL: 'wss://nt3enat0ik.execute-api.us-west-2.amazonaws.com/dev',
  DECK_EXPORT_URL: 'https://89lpls2fsg.execute-api.us-west-2.amazonaws.com/deck/export',
  DECK_PAGES_URL: 'https://89lpls2fsg.execute-api.us-west-2.amazonaws.com/deck/pages',
